...
Parameters::Parameters():
        ...
        PARAM_INCLUDE_ADJACENT_SEQ(PARAM_INCLUDE_ADJACENT_SEQ_ID, "--include-adjacent-seq", "Compare adjacent sequences to k-mers", "Compare sequence information adjacent to k-mers and select multiple representative sequences per cluster", typeid(bool), (void *) &includeAdjacentSeq, "", MMseqsParameter::COMMAND_CLUSTLINEAR),
...
//    combinepvalperset.push_back(&PARAM_SHORT_OUTPUT);
    ...
    kmermatcher.push_back(&PARAM_INCLUDE_ADJACENT_SEQ);

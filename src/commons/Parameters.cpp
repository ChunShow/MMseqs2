...
Parameters::Parameters():
        ...
        PARAM_INCLUDE_ADJACENT_SEQ(PARAM_INCLUDE_ADJACENT_SEQ_ID, "--match-adjacent-seq", "Compare adjacent sequences to k-mers", "Compare sequence information adjacent to k-mers and select multiple representative sequences per cluster", typeid(bool), (void *) &includeAdjacentSeq, "", MMseqsParameter::COMMAND_CLUSTLINEAR),
